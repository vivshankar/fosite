...
type DeviceCodeStorage interface {
	...
	CreateDeviceCodeSession(ctx context.Context, signature string, request fosite.DeviceAuthorizationRequester) (err error)

	// UpdateDeviceCodeSession update in store the device code session for a given device code.
	UpdateDeviceCodeSession(ctx context.Context, signature string, request fosite.DeviceAuthorizationRequester) (err error)
	...
	GetDeviceCodeSession(ctx context.Context, signature string, session fosite.Session) (request fosite.DeviceAuthorizationRequester, err error)
...
type UserCodeStorage interface {
	...
	CreateUserCodeSession(ctx context.Context, signature string, request fosite.DeviceAuthorizationRequester) (err error)
	...
	GetUserCodeSession(ctx context.Context, signature string, session fosite.Session) (request fosite.DeviceAuthorizationRequester, err error)
	...
	UpdateUserCodeSession(ctx context.Context, signature string, req fosite.DeviceAuthorizationRequester) error
}
